...
export default function Result() {
  ...
  return (
    <div className="grid font-fredoka text-custom-blue grid-rows-[20px_auto_1fr] items-center justify-items-center min-h-screen p-8 pb-20 bg-white gap-8 sm:p-20 font-[family-name:var(--font-geist-sans)]">
